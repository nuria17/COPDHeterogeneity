...
### FUNCTIONS ###
def tuning_resolution(reso_min,reso_max, fileA, fileB, fileC, output):
    '''
    ...
    '''
    for i in range(reso_min, reso_max, 1):
        a=i/10
...
tuning_resolution(reso_min= 10, reso_max= 30, fileA= '/home/nuria/Desktop/CV_filt/Backbones_molti/Backbone_closure_ultra_mrna.ncol', fileB= '/home/nuria/Desktop/CV_filt/Backbones_molti/Backbone_closure_ultra_methy.ncol', fileC= '/home/nuria/Desktop/CV_filt/Backbones_molti/Backbone_closure_ultra_micro_good.ncol', output= '/home/nuria/Desktop/Reviewers_comments/ResolutionTuning/Communities_all_p')
